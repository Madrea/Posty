...
<html lang="en">
    ...
    <body class="body">
        <nav class="up">
            <ul class="up-part">
                <li>
                    <!-- <button class="p-3 like-unlike-button" wire:click="home"><i class="fa-solid fa-house pr-1"></i>Home</button> -->
                    <a href="{{ route('home') }}" class="p-3"><i class="fa-solid fa-house pr-1"></i>Home</a>
                </li>
                <li>
                    <a href="{{ route('dashboard') }}" class="p-3"><i class="fa-solid fa-gauge pr-1"></i>Dashboard</a>
                    <!-- <button class="p-3 like-unlike-button"><i class="fa-solid fa-gauge pr-1"></i>Dashboard</button> -->
                </li>
                <li>
                    <a href="{{ route('posts') }}" class="p-3"><i class="fa-solid fa-file-lines pr-1"></i>Post</a>
                    <!-- <button class="p-3 like-unlike-button" wire:click="home"><i class="fa-solid fa-house pr-1"></i>Post</button> -->
                </li>
            </ul>
